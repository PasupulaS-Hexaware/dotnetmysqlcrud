...
using dotnetmysqlbpcr.Api.Filters;
using dotnetmysqlbpcr.Business.Installer;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
using Microsoft.Extensions.Logging;

namespace dotnetmysqlbpcr.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetmysqlbpcr API", Version = version + "-" + branch });
        });
