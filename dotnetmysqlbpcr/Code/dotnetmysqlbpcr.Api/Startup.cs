using dotnetmysqlbpcr.Api.Installer;
using dotnetmysqlbpcr.Api.Middleware;
using dotnetmysqlbpcr.Data.Repositories;
...
using System;
using dotnetmysqlbpcr.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;
namespace dotnetmysqlbpcr.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetmysqlbpcr V1");
        });
