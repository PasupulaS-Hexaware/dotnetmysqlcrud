...
{
    public class When_updating_studentcon : UsingStudentconServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _studentconRepository.Update( _studentcon).Returns(_studentcon);
        ...
        {
            _studentconRepository.Received(1).Update( _studentcon);
